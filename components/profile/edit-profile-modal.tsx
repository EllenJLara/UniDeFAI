...
const EditProfileModal = ({
  ...
  const [profile, setProfile] = useState<IProfile>({
    ...
    avatar: { url: user?.image || "", file: undefined },
  });
    ...
    <>
      <Dialog open={true} onOpenChange={closeModal}>
        <DialogContent className="p-0 pb-4 max-w-[600px] max-h-[90vh] h-fit rounded-2xl overflow-y-auto">
          ...
          <div className="relative -top-[60%] left-[4%] rounded-[7px] transition cursor-pointer h-[10vh] w-[10vh] border-[4px] dark:border-black border-white">
            <Image
              src={
                profile?.avatar?.file
